...
// except we’ve added scroll to top and scroll to bottom buttons. 
// Your job is to expose the imperative methods scrollToTop and scrollToBottom 
// on a ref so the parent component can call those directly.
